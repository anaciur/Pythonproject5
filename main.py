...
extend_graph_selective('scaffolds#.tsv', 50, graph1, 0)

# add the interactions of the 2nd layer - i.e the 3rd layer
extend_graph_selective('2nd_layer#.tsv', 40, graph1, 0)
...
extend_graph_selective('3rd_layer#.tsv', 30, graph1, 0)

# add the interactions of the 4th layer - i.e the 5th layer
extend_graph_selective('4th_layer#.tsv', 20, graph1, 0)

# add the interactions of the 5th layer - i.e the 6th layer
extend_graph_selective('5th_layer#.tsv', 10, graph1, 0)
'''
